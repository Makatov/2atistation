...
namespace Asteroids
{
    public partial class Form1 : Form
    {
        ...
        private void pictureBox1_Paint(object sender, PaintEventArgs e)
        {
            g = e.Graphics;
            g.Clear(Color.Black);
            g.FillRectangle(new SolidBrush(Color.DarkBlue), new Rectangle(10, 10, 766, 442));
            ...
            g.DrawString("Level: 1 Score: 200 Live: ***", new Font (FontFamily.GenericSansSerif, 12), new SolidBrush(Color.Black), 525, 20);
            g.FillPolygon(new SolidBrush(Color.DarkRed), new Point[3] { new Point(100, 130), new Point(120, 100), new Point(140, 130) });
            g.FillPolygon(new SolidBrush(Color.DarkRed), new Point[3] { new Point(100, 110), new Point(120, 140), new Point(140, 110) });
            g.FillPolygon(new SolidBrush(Color.DarkRed), new Point[3] { new Point(140, 260), new Point(160, 230), new Point(180, 260) });
            g.FillPolygon(new SolidBrush(Color.DarkRed), new Point[3] { new Point(140, 240), new Point(160, 270), new Point(180, 240) });
            g.FillPolygon(new SolidBrush(Color.DarkRed), new Point[3] { new Point(600, 110), new Point(620, 80), new Point(640, 110) });
            g.FillPolygon(new SolidBrush(Color.DarkRed), new Point[3] { new Point(600, 90), new Point(620, 120), new Point(640, 90) });
            g.FillPolygon(new SolidBrush(Color.DarkRed), new Point[3] { new Point(520, 350), new Point(540, 320), new Point(560, 350) });
            g.FillPolygon(new SolidBrush(Color.DarkRed), new Point[3] { new Point(520, 330), new Point(540, 360), new Point(560, 330) });
